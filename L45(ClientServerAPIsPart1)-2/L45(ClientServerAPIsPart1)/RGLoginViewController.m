...
@interface RGLoginViewController () <UIWebViewDelegate>

@property (copy, nonatomic) RGLoginCompletionBlock completionBlock;
...
//
////    if ([[[request URL] host] isEqualToString:@"blank.html"]) {
////
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if ([[[request URL] description] rangeOfString:@"#access_token="].location != NSNotFound) {
        ...
        RGAccessToken* token = [[RGAccessToken alloc] init];
